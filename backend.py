...
def search_box():
    if request.method == 'POST':
        ...
        if site_id == "all":
            total_sites, total_completed_site_num, matching_sites, matching_sites_list, unmatching_sites_list, incomplete_sites_list = all_site_search(
                queries, equation, run_id)
            result = {
                'grid_search': True,
