...
# MUST REMOVE state="WAITING" from following query
GET_ALL_RUNS_DATA = 'SELECT * FROM run WHERE (state="COMPLETED" or state="TIMED_OUT" or state="STARTED") ORDER BY run_id DESC'
